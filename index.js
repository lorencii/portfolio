  ...
  const translations = {
    en: {
      ...
      "skills.react": "Component-based architecture, Hooks, State Management, Context API, React Router, Performance Optimization.",
      "skills.node": "Express.js, REST APIs, NPM package management, asynchronous programming, database integration.",
      "skills.tailwind": "Utility-first styling, responsive layouts, theme configuration, custom components, JIT compiler, dark mode design.",
      "skills.supabase": "PostgreSQL databases, Authentication, Edge Functions, Real-time subscriptions, Row Level Security (RLS), Storage.",
      "skills.github": "Version control, branching strategies, Pull Requests, code reviews, GitHub Actions (CI/CD), issue tracking.",
    ...
    sq: {
      ...
      "skills.css": "Flexbox, Grid, Animations, Transitions, Custom Properties, Media Queries, Pseudo-elements.",
      "skills.js": "ES6+, DOM API, Fetch, Async/Await, Event Handling, Local Storage, JSON manipulation.",
      "skills.react": "Arkitekturë e bazuar në komponentë, Hooks, State Management, Context API, React Router, Optimizim Performance.",
      "skills.node": "Express.js, REST APIs, menaxhim paketash NPM, programim asinkron, integrim me databaza.",
      "skills.tailwind": "Stilim utility-first, layouts responsive, konfigurim temash, komponentë të personalizuar, dizajnim dark mode.",
      "skills.supabase": "Databaza PostgreSQL, Autentikim, Edge Functions, real-time subscriptions, Row Level Security (RLS), Storage.",
      "skills.github": "Kontroll versioni, strategji degëzimi, Pull Requests, rishikim kodi, GitHub Actions (CI/CD), ndjekje e problemeve.",
